...
namespace System.Drawing
{
    public sealed class Region : MarshalByRefObject, IDisposable
    {
        ...
        {
            Gdip.CheckStatus(Gdip.GdipCreateRegionRgnData(rgnData.Data, rgnData.Data.Length, out _nativeRegion));
        }
        ...
        public RegionData? GetRegionData()
        {
            ...
            Gdip.CheckStatus(Gdip.GdipGetRegionData(SafeRegionHandle, regionData, regionSize, out _));
