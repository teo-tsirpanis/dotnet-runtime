...
namespace System.Drawing.Drawing2D
{
    public sealed class Matrix : MarshalByRefObject, IDisposable
    {
        ...
        internal IntPtr NativeMatrix => _nativeMatrix.DangerousGetHandle();
        ...
        private Matrix(SafeMatrixHandle nativeMatrix) => _nativeMatrix = nativeMatrix;
