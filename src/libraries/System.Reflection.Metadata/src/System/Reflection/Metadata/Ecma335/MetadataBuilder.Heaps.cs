...
namespace System.Reflection.Metadata.Ecma335
{
    public sealed partial class MetadataBuilder
    {
        ...
        private BlobBuilder _userStringBuilder;
        ...
        private BlobBuilder _guidBuilder;
            ...
            Func<int, BlobBuilder>? createBlobBuilderFunc = null)
        {
            ...
            _blobBuilder = _createBlobBuilderFunc(1024);
        ...
        public void SetCapacity(HeapIndex heap, int byteCount)
        {
            ...
            {
                case HeapIndex.Blob:
                    if (byteCount > _blobBuilder.Count)
                    {
                        _blobBuilder.Capacity = byteCount;
                    }
                    break;
